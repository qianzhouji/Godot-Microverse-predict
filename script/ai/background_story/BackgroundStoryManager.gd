...
static var BACKGROUND_CONFIGS = {
	...
	"School": {
		"company_name": "阳光学院",
		"company_description": "一所注重全面发展的现代化学校，致力于培养学生的学术能力和综合素质。学校设有小学部、初中部和高中部，拥有优秀的师资力量和完善的教学设施。学校特色课程包括编程、机器人、艺术创作等。",
		"environment_description": "校园占地50亩，有3栋教学楼、1栋图书馆、1栋实验楼、1个体育馆、1个标准操场和多个花园休息区。教学楼配备多媒体教室、计算机房、音乐室、美术室。校园绿化率高，环境优雅，是学习和成长的理想场所。",
		"time_period": "现代（2024年秋季学期）",
		"cultural_context": "现代教育文化，强调素质教育、个性发展和终身学习。注重培养学生的批判性思维、创新能力和社会责任感。师生关系平等尊重，鼓励自主学习和合作探究。",
		"economic_situation": "学校是市重点公立学校，政府拨款充足，学费合理。设有奖学金制度，资助优秀学生。",
		"social_rules": [
